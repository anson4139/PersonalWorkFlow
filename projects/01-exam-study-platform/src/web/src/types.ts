...
export const SUBJECTS: SubjectMeta[] = [
  ...
  { key: "big-data", label: "AI規劃師 第二科", groupKey: "ai-planner-mid" },
  {
    ...
    label: "AI規劃師 第三科",
    groupKey: "ai-planner-mid",
  },
  {
    key: "ai-planning-basic",
    label: "初級AI規劃師 第一科（人工智慧基礎概論）",
    groupKey: "ai-planner-basic",
  },
  {
    key: "gen-ai-basic",
    label: "初級AI規劃師 第二科（生成式AI應用與規劃）",
    groupKey: "ai-planner-basic",
  },
  {
    key: "ecommerce-finance-midterm-113",
    label: "113電子商務財務管理(期中考)",
    groupKey: "ecommerce-course",
  },
  {
    key: "securities-broker-law-110",
    label: "法規與實務（110年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-law-111",
    label: "法規與實務（111年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-law-112",
    label: "法規與實務（112年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-law-113",
    label: "法規與實務（113年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-law-114",
    label: "法規與實務（114年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-law-115",
    label: "法規與實務（115年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-finance-110",
    label: "投資與財務分析（110年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-finance-111",
    label: "投資與財務分析（111年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-finance-112",
    label: "投資與財務分析（112年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-finance-113",
    label: "投資與財務分析（113年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-finance-114",
    label: "投資與財務分析（114年）",
    groupKey: "securities-broker",
  },
  {
    key: "securities-broker-finance-115",
    label: "投資與財務分析（115年）",
    groupKey: "securities-broker",
  },
];
...
export const PARENT_GROUPS: ParentGroup[] = [
  {
    key: "ai-planner",
    title: "AI應用規劃師",
    groupKeys: ["ai-planner-basic", "ai-planner-mid"],
  },
];

export const ALL_SUBJECT_KEYS = SUBJECTS.map(
  (subject) => subject.key,
) as SubjectKey[];
export const PUBLIC_SUBJECT_KEYS: SubjectKey[] = [
  "ecommerce-finance-midterm-113",
  "ai-planning-basic",
  "gen-ai-basic",
];
